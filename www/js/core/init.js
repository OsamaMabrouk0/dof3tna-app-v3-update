(function (App) {
    ...
    function initApp() {
        ...
        setTimeout(function () { App.Router.go('home', false, false); }, 100);

        App._initialized = true;
        showConnectionStatus();

        if (App.Pages.initNotificationsBadge) App.Pages.initNotificationsBadge();
    }
    ...
    function showConnectionStatus() {
        if (!navigator.onLine) {
            setTimeout(() => { App.Toast.warning('أنت غير متصل بالإنترنت', 'وضع غير متصل'); }, 1000);
        }
        ...
        window.addEventListener('online', function () {
            ...
            if (App.State.currentPage === 'lectures' ||
                ...
                setTimeout(() => { App.Router.go(App.State.currentPage, false, false); }, 500);
            }
        });
        ...
        setTimeout(function () {
            ...
            setTimeout(function () {
                ...
                animatedElements.forEach(function (el, index) {
                    ...
                    setTimeout(function () { el.classList.add('visible'); }, index * 100);
                });
            }, 50);
        }, 500);
    }
    ...
    window.addEventListener('load', function () { setTimeout(hideSkeletons, 200); });
