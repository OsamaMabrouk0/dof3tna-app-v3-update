(function(App) {
    ...
    App.State.Theme = {
        init: function() {
            ...
            if (savedTheme === 'dark') {
                ...
                if (savedOled) html.classList.add('oled');
            } else {
        ...
        toggleDark: function() {
            ...
            if (isDark) {
                ...
                if (wasOled) html.classList.add('oled');
            }
            ...
            if (App.State.currentPage === 'settings') {
                ...
                if (darkToggle) darkToggle.checked = html.classList.contains('dark');
                if (oledToggle) oledToggle.checked = html.classList.contains('oled');
            }
        },
        ...
        toggleOled: function() {
            ...
            if (!isDark) {
                ...
                const oledToggle = document.getElementById('oled-mode-toggle');
                if (oledToggle) oledToggle.checked = false;
                return;
            }
    ...
    App.State.Connection = {
        ...
        init: function() {
            ...
            window.addEventListener('online', function() { self.updateUI(true); });
            window.addEventListener('offline', function() { self.updateUI(false); });
        }
    };
