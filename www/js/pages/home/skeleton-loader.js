...
(function() {
    ...
    function buildRecentFilesCard() {
        const files = Array(4).fill(0).map((_, i) => `
            <div class="skeleton-file-item skeleton-shimmer">
                ...
                <div class="skeleton-file-content">
                    <div class="skeleton-file-name skeleton-shimmer" style="width:${60 + i * 7}%"></div>
        ...
        return `
            <div class="skeleton-recent-card">
                <div class="skeleton-card-header">
                    ...
                    <div class="skeleton-card-action skeleton-shimmer"></div>
                </div>
                ${files}
            </div>
        `;
    ...
    function buildStatsCard() {
        return `
            <div class="skeleton-stats-card">
                ...
                <div class="skeleton-chart-ring skeleton-shimmer"></div>
                <!-- Two stat boxes -->
                <div class="skeleton-stats-grid">
                    <div class="skeleton-stat-box skeleton-shimmer"></div>
                    <div class="skeleton-stat-box skeleton-shimmer"></div>
                </div>
                <!-- Mini progress bars inside stat boxes hint -->
                <div class="skeleton-stat-progress skeleton-shimmer"></div>
            </div>
        `;
    }

    function buildNotificationsSection() {
        const notifications = Array(3).fill(0).map((_, i) => `
            <div class="skeleton-notif-item skeleton-shimmer">
                ...
                <div class="skeleton-notif-content">
                    <div class="skeleton-notif-header">
                        ...
                        <div class="skeleton-notif-time skeleton-shimmer"></div>
                    </div>
                    <div class="skeleton-notif-text skeleton-shimmer" style="width:${85 - i * 5}%"></div>
                    <div class="skeleton-notif-text skeleton-shimmer" style="width:${60 - i * 5}%"></div>
                </div>
            </div>
        `).join('');
        ...
        return `
            <div class="skeleton-notifications">
                ...
                ${notifications}
                <div class="skeleton-notif-footer skeleton-shimmer"></div>
            </div>
        `;
    }
