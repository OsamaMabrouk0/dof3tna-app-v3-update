(function (App) {
    ...
    const NOTIFICATIONS_URL = 'https://raw.githubusercontent.com/OsamaMabrouk0/dof3tna-app-v3-update/main/notifications.json';
        ...
        fullList.innerHTML = `
            <div class="text-center py-20">
                <div class="w-20 h-20 rounded-full bg-gradient-to-br from-red-500/20 to-orange-500/20
                            flex items-center justify-center mx-auto mb-5">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-10 h-10 text-red-500">
