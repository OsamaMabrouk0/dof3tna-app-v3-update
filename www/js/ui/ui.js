(function(App) {
    ...
    App.UI.Sidebar = {
        ...
        render: function() {
            ...
            // على الموبايل: لا نعرض Sidebar أصلاً
                    ...
                    <div class="sidebar-link-wrapper group relative">
                        <a href="#${id}" 
                           ...
                           aria-label="${title}">
                            ...
                            <!-- Active Indicator -->
                            ${isActive ? `
                                <div class="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-10 bg-gradient-to-b from-blue-500 to-cyan-500 rounded-r-full transition-all duration-300"></div>
                            ` : ''}
            ...
            App.PAGES.forEach(page => {
                content += createLink(page, page.id);
            });
        ...
        toggle: function(show) {
            // على الموبايل: استخدم Bottom Sheet
            if (window.innerWidth < 768) {
    ...
    App.UI.BottomSheet = {
        ...
        create: function() {
            ...
            this.sheet.innerHTML = `
                <div class="bg-white dark:bg-[#0f172a] dark:oled:bg-black rounded-t-3xl shadow-2xl max-h-[85vh] overflow-hidden flex flex-col">
                    ...
                    <!-- Drag Handle Area - منطقة السحب المخصصة -->
                    ...
                    <!-- Content Area - منطقة المحتوى القابلة للتمرير -->
                    <div class="content-scrollable overflow-y-auto custom-scrollbar flex-1 p-4" id="bottom-sheet-content">
        ...
        setupDragToClose: function() {
            // السحب يعمل فقط من منطقة الـ drag handle
            ...
            this.dragHandle.addEventListener('touchmove', (e) => {
                ...
                if (diff > 0) {
                    ...
                    // تقليل opacity للـ overlay مع السحب
                    const opacity = Math.max(0.6 - (diff / 500), 0);
            ...
            this.dragHandle.addEventListener('touchend', (e) => {
                ...
                // إغلاق إذا تم السحب أكثر من 150px
                if (diff > 150) {
                    this.toggle(false);
                } else {
        ...
        renderContent: function() {
            ...
            const createCard = (page, id, isHome = false) => {
                ...
                return `
                    <a href="#${id}" 
                       data-page="${id}" 
                       class="bottom-sheet-card ${isActive ? 'active' : ''}" 
                       role="button">
            ...
            // Other pages
            App.PAGES.forEach(page => {
                content += createCard(page, page.id);
            });
        ...
        attachEvents: function() {
            const links = document.querySelectorAll('#bottom-sheet-content a[data-page]');
    ...
    App.UI.bindHeaderButtons = function() {
        const handlers = {
            ...
            'open-sidebar': () => {
                if (window.innerWidth < 768) {
                    App.UI.BottomSheet.toggle(true);
                } else {
